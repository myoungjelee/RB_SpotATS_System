...
bool ats_msgs__msg__plan_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ats_msgs.msg._plan_command.PlanCommand", full_classname_dest, 38) == 0);
  }
  ats_msgs__msg__PlanCommand * ros_message = _ros_message;
  {  // stamp
...
PyObject * ats_msgs__msg__plan_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ats_msgs.msg._plan_command");
